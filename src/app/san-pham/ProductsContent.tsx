...
import { skinConcerns, categories, Product } from "@/lib/data";
      ...
      <div className="container-custom">
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="lg:hidden flex justify-between items-center bg-surface p-4 rounded-sm mb-6">
            <p className="text-sm font-medium">Hiển thị {sortedProducts.length} sản phẩm</p>
            <MobileFilter 
              categories={categories}
              concerns={skinConcerns}
              activeCategory={activeCategory}
          ...
          <div className="flex-1 space-y-8">
            <div className="hidden lg:flex justify-between items-center border-b border-surface pb-4">
               <p className="text-sm text-muted">Hiển thị {sortedProducts.length} trong {products.length} sản phẩm</p>
